        ...
        <div className="mt-10">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div id="petoria" className="border rounded-md p-6 bg-transparent">
              <h4 className="text-lg font-semibold text-foreground mb-2">Petoria <span className="ml-2 text-xs px-2 py-1 bg-muted/10 rounded">Live</span></h4>
            ...
            <div className="border rounded-md p-6 bg-transparent">
              <h4 className="text-lg font-semibold text-foreground mb-1">HMS (Hotel Management System) <span className="ml-2 text-xs px-2 py-1 bg-muted/10 rounded">In Progress</span></h4>
              <p className="text-sm text-muted-foreground mb-3">
